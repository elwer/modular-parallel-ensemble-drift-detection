import warnings
# Suppress scipy p-value warnings from anderson_ksamp - must be set before importing scipy
warnings.filterwarnings('ignore', category=UserWarning, message=r'p-value')
