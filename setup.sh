...
cd /data/horse/ws/s4122485-parallelDD/new/modular-parallel-ensemble-drift-detection
...
source /data/horse/ws/s4122485-parallelDD/modular-parallel-ensemble-drift-detection/venv/bin/activate
export PYTHON_GIL=0
